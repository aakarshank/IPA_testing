...
// Action name: UpdateLoyaltyBronzeMin
// Arguments: int newBronzeMin
Future<void> updateBronzeMin(int newBronzeMin) async {
  ...
  for (var userDoc in usersQuerySnapshot.docs) {
    ...
    for (var loyaltyDoc in loyaltyQuerySnapshot.docs) {
      // Update the bronzeMin field
      await loyaltyDoc.reference.update({'bronzeMin': newBronzeMin});
    }
  }
}
