...
// Action name: UpdateLoyaltySilverMin
// Arguments: int newSilverMin
Future<void> updateSilverMin(int newSilverMin) async {
  ...
  for (var userDoc in usersQuerySnapshot.docs) {
    ...
    for (var loyaltyDoc in loyaltyQuerySnapshot.docs) {
      // Update the silverMin field
      await loyaltyDoc.reference.update({'silverMin': newSilverMin});
    }
  }
}
